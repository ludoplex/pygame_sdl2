...
pygame.image.save(img, f"{fn}_new.png")

w, h = img.get_size()

img_flip = pygame.transform.flip(img, False, True)
pygame.image.save(img_flip, f"{fn}_flip.png")

img_90 = pygame.transform.rotate(img, 90)
pygame.image.save(img_90, f"{fn}_90.png")

img_45 = pygame.transform.rotate(img, 45)
pygame.image.save(img_45, f"{fn}_45.png")

img_scale = pygame.transform.scale(img, (w*2, h*2))
pygame.image.save(img_scale, f"{fn}_scale.png")

img_smoothscale = pygame.transform.smoothscale(img, (w*2, h*2))
pygame.image.save(img_smoothscale, f"{fn}_smoothscale.png")

img_scale2x = pygame.transform.scale2x(img)
pygame.image.save(img_scale2x, f"{fn}_scale2x.png")
...
pygame.image.save(img_draw, f"{fn}_draw.png")
